<?php
	...
	@define('CONST_Database_DSN', 'pgsql://NOMINATIMDBUSERNAME:NOMINATIMDBPASSWORD@NOMINATIMDBHOST:NOMINATIMDBPORT/nominatim'); // <driver>://<username>:<password>@<host>:<port>/<database>
